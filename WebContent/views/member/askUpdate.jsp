...
<html>
<head>
    <title>1:1 문의게시판 수정</title>
    <script type="text/javascript">
        function cancelEdit() {
            if (confirm("수정을 취소하시겠습니까?")) {
                alert("작업이 취소되었습니다.");
                window.location.href = "${pageContext.request.contextPath}/admin/askList.do"; // 여기에 목록 페이지의 URL을 입력하세요.
            }
        }
...
<form action="${pageContext.request.contextPath}/admin/askupdate.do" method="POST" onsubmit="return validateForm();">
