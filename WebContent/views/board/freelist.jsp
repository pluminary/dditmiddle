...
<section id="con_freeList" class="conBody tab">
	...
	<%
		List<FreeBoardVO> boardList = (List<FreeBoardVO>) request.getAttribute("boardList");
	    ...
	    <div class="list_area">
	        ...
	        <div class="l_top">
	            ...
	            <div class="srch_area wide">
	            	<form action="<%=request.getContextPath()%>/freeboard/list.do" method="get" class="flex">
			        	<select name="sort" onchange="this.form.submit()" id="" class="view_num">
			            	<option value="latest" ${"latest".equals(param.sort) ? "selected" : ""}>최신순</option>
			            	<option value="views" ${"views".equals(param.sort) ? "selected" : ""}>조회수순</option>
			        	</select>
			        	<span class="line"></span>
	                    <input type="text" name="searchKeyword" value="${param.searchKeyword}" class="se_in" placeholder="제목 검색">
            ...
            <div class="page">
			    <ul>
				    ...
				    %>
		                ...
		                <li class="prev">
		                    <a href="list.do?pageNo=<%= pageVO.getPageNo() - 1 %><%= currentSort %><%= searchKeyword %>">Prev</a>
		                </li>
				    ...
				    %>
		                ...
		                <li class="num <%= pageVO.getPageNo() == i ? "on" : "" %>">
		                    <a href="list.do?pageNo=<%= i %><%= currentSort %><%= searchKeyword %>"><%= i %></a>
		                </li>
				    ...
				    %>
		                ...
		                <li class="next">
		                    <a href="list.do?pageNo=<%= pageVO.getPageNo() + 1 %><%= currentSort %><%= searchKeyword %>">Next</a>
		                </li>
...
%>
			...
			<div class="btn_area">
				<div class="btn">
					<form action="<%=request.getContextPath()%>/freeboard/insert.do"
						method="get">
