...
@WebServlet("/member/askdetail.do")
public class askboardDetailforMember extends HttpServlet{
	...
	req.getRequestDispatcher("/views/member/askdetailforMember.jsp").forward(req, resp);
